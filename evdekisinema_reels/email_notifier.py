    ...
    if is_success:
        ...
        <body style="font-family: Arial, sans-serif; background-color: #f4f4f7; padding: 20px;">
            <div style="max-width: 600px; margin: auto; background: #ffffff; padding: 25px; border-radius: 8px; border-top: 5px solid #28a745;">
                <h2 style="color: #28a745; margin-top: 0;">🍿 Instagram Reel Paylaşıldı!</h2>
                <p><strong>Film / Dizi:</strong> {title}</p>
                <p><strong>Paylaşım Zamanı:</strong> {now_str}</p>
                <div style="margin: 25px 0;">
                    <a href="{url}" style="background-color: #E1306C; color: #ffffff; padding: 12px 20px; text-decoration: none; border-radius: 5px; font-weight: bold; display: inline-block;">Reel'i Görüntüle ↗</a>
                </div>
            </div>
        </body>
        </html>
        ...
        <body style="font-family: Arial, sans-serif; background-color: #f4f4f7; padding: 20px;">
            <div style="max-width: 600px; margin: auto; background: #ffffff; padding: 25px; border-radius: 8px; border-top: 5px solid #dc3545;">
                <h2 style="color: #dc3545; margin-top: 0;">⚠️ Instagram Paylaşım Hatası</h2>
